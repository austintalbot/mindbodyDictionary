	...
	private void InitializeFaqItems()
	{
		...
		[
			new FaqItem
			{
				...
				Answer =
					"The Mind Body Dictionary is an app that explores the mind-body connection, showing how physical symptoms relate to emotional and psychological states.",
			},
			new FaqItem
			{
				Question = "How do I search for a condition?",
				Answer =
					"Use the Conditions tab to browse all mind-body conditions. You can search by name or explore different categories.",
			},
			new FaqItem
			{
				Question = "What does Premium offer?",
				Answer =
					"Premium membership provides access to detailed recommendations, resources, and exclusive content for deeper exploration.",
			},
			new FaqItem
			{
